!function(e, t) {
    ...
    return function() {
        ...
        Pr("\\LaTeX", "\\textrm{\\html@mathml{L\\kern-.36em\\raisebox{" + Pn + "}{\\scriptstyle A}\\kern-.15em\\TeX}{LaTeX}}"),
        Pr("\\KaTeX", "\\textrm{\\html@mathml{K\\kern-.17em\\raisebox{" + Pn + "}{\\scriptstyle A}\\kern-.15em\\TeX}{KaTeX}}"),
        ...
        var Gn = {
          ...
          , Un = function() {
            ...
            t.expandTokens = function(e) {
                ...
                for (this.pushTokens(e); this.stack.length > r; ) {
                    ...
                    n instanceof Gr && (n.treatAsRelax && (n.noexpand = !1,
                    n.treatAsRelax = !1),
          ...
          , jn = function() {
            ...
            t.parseSymbol = function() {
                ...
                _n.hasOwnProperty(t[0]) && !ae[this.mode][t[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e),
                t = _n[t[0]] + t.slice(1));
                var i, o = In.exec(t);
